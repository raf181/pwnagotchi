...
// Only the compiled .mo catalogs are embedded (runtime needs); the
// editable .po sources + voice.pot template live at locale-src/,
// a Go-owned but non-embedded location — see that directory's README.
//
//go:embed locale/*/LC_MESSAGES/*.mo
